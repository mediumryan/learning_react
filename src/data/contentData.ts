...
import counter from "~/../public/assets/images/contents/counter.gif";
import props from "~/../public/assets/images/contents/props.png";
import propsExample from "~/../public/assets/images/contents/props_exam.png";
import propsDestructuring from "~/../public/assets/images/contents/props_destructuring.jpg";
import event from "~/../public/assets/images/contents/event.png";
import eventFow from "~/../public/assets/images/contents/event_handling.png";
import eventDiff from "~/../public/assets/images/contents/event_diff.png";
import eventHandlerExample from "~/../public/assets/images/contents/event_handler_example.gif";
import arrowFunction from "~/../public/assets/images/contents/arrow_function.png";
import eventStateChange from "~/../public/assets/images/contents/event_state_change.gif";
import arrayObject from "~/../public/assets/images/contents/array_object.jpg";
import spreadOperator from "~/../public/assets/images/contents/spread_operator.png";
import immutable from "~/../public/assets/images/contents/immutable.jfif";
import formExample from "~/../public/assets/images/contents/form_example.gif";
import basicTodo from "~/../public/assets/images/contents/basic_todo.gif";
import extractingError from "~/../public/assets/images/contents/extracting_error.png";
import extracting from "~/../public/assets/images/contents/extracting.png";
import todoDelete from "~/../public/assets/images/contents/todo_delete.gif";
import github from "~/../public/assets/images/contents/github.png";
import githubDeployment1 from "~/../public/assets/images/contents/github_deployment_1.png";
import githubDeployment2 from "~/../public/assets/images/contents/github_deployment_2.png";
import posting from "~/../public/assets/images/contents/posting.png";
import reactLifecycle from "~/../public/assets/images/contents/react_lifecycle.jpg";
import useEffectImg from "~/../public/assets/images/contents/useeffect.png";
import useEffect3Cases from "~/../public/assets/images/contents/useeffect_3case.png";
import localStorageSessionStorage from "~/../public/assets/images/contents/local_storage_session_storage.png";
import storageExample from "~/../public/assets/images/contents/storage_example.gif";
...
![props destructuring](${propsDestructuring})
...
**🖥️ 브라우저 출력 결과** 
![Event handler example](${eventHandlerExample})
...
![Event and State](${eventStateChange})
...
![extracting-error](${extractingError})
...
배포를 하기 전, 먼저 우리의 코드를 **GitHub** 라는 안전한 저장소에 올려두어야 합니다.
...
![useEffect-3patterns](${useEffect3Cases})
...
![storage](${localStorageSessionStorage})
...
![storage-example](${storageExample})
...
**🖥️ ブラウザの出力結果** ![props example](${propsExample})
...
\`\`\`jsx
import { useState } from 'react';
// TodoForm と TodoList を読み込むコードを追加します。
import TodoForm from './components/TodoForm';
import TodoList from './components/TodoList';
...
function App() {
  ...
  return (
    <div>
      <h1>My Todo List</h1>
      {/* ここに TodoForm と TodoList を呼び出すコードが必要！ */}
      <TodoForm />
      <TodoList />
    </div>
  );
...
> おそらく画面が **真っ白になり、何も表示されなくなる** はずです。焦らないでください！ 開発者ツール（F12） のコンソールを開いてみると、 **"Cannot read properties of undefined (reading 'map')"** といったエラーメッセージが表示されているはずです。 
...
function TodoForm() {
  return (
    // ❓ この部屋には"input", "setInput", "onSubmit"という家具はありません。
    <form onSubmit={onSubmit}>
      <input
        value={input}
        onChange={(e) => setInput(e.target.value)}
...
return (
  <div>
    <h1>My Todo List</h1>
    {/* 🚚 データを送るときは、コンポーネントタグの中に「名前={値}」で書きます！ */
    <TodoForm input={input} setInput={setInput} onSubmit={onSubmit} />
    <TodoList todos={todos} />
  </div>
);
...
### デプロイ完了後の確認
デプロイが成功すると、 **GitHub Pages** が自動的にあなたのアプリをホストしてくれます.
![github-deployment-1](${githubDeployment1})
そこで **GitHub Pages** が生成した **公式URLアドレス** をコピーして、 ブラウザに貼り付けてみてください！ あなたのアプリが世界中のどこからでもアクセスできるようになっています！ 🌍✨
![github-deployment-2](${githubDeployment2})
